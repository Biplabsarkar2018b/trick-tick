...
const MasonryLayout = () => {
  ...
  const fetchData = () => {
    console.log(`Page value is ${page} from masonry layout`);
    axios
  ...
  return (
    <div className={`flex flex-col relative photospagescrollbar`}>
      ...
      {/* Pop Up On Click */}
      {isPopUp && (
        <div onClick={()=>setisPopUp(false)} className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center z-50 bg-gray-500 bg-opacity-75">
          <div className="p-4 bg-white rounded-md flex flex-col gap-3">
            <img className="rounded-lg" src={popUpData?.urls?.small} alt="" />
